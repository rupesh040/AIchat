  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-bl from-black via-[#101010] to-black relative overflow-hidden">
      <div className="relative max-w-md w-full mx-4 ">
        {/* Main Card */}
        <div className="bg-black rounded-3xl shadow-2xl overflow-hidden relative bg-opacity-60 backdrop-blur-xl border-[1px] border-zinc-900 ">
        ...
        {!loading ?      <>  {activeForm === 'login' && 'Sign In'}
                  {activeForm === 'signup' && 'Create Account'}</>   :
