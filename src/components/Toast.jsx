...
const Toast = () => {
    ...
    return (toast.length > 0 ? toast.map((item, index) => <>
        ...
        }} className={`fixed ${toast ? " scale-100 blur-0" : "-top-10 scale-0 blur-sm"}  transition-all duration-300 left-[50%] translate-y-[-50%] translate-x-[-50%] w-[90%] max-w-96 z-[9999]  rounded-xl bg-white flex flex-col px-3 justify-center gap-1 py-2`}>
